...
public class PostMapper extends DBMapper {
	...
	public ArrayList<PostDTO> fetchPost (Integer pageNo, Integer pageLimit){
		...
		try (PreparedStatement fetchPostPst = getConnection().prepareStatement(fetchPostStr)) {
			...
			while (rSet != null && rSet.next()) {
				PostDTO postDTO = getPostDTOFromCurrentResultSet(rSet);
	...
	public ArrayList<PostDTO> searchPost (PostDTO similarPost, Integer pageNo){
		return searchPost(similarPost, pageNo, DEFAULT_PAGE_LIMIT);
	}
	
	public ArrayList<PostDTO> searchPost (PostDTO similarPost, Integer pageNo, Integer pageLimit){
		
		ArrayList<PostDTO> searchPostResult = new ArrayList<>();
	...
	private PostDTO getPostDTOFromCurrentResultSet (ResultSet rSet) throws Exception {
	...
	private String getSearchSQLFromDTO (PostDTO similarPost) {
