...
public class DriverConnector {
	...
	private static final String SAVE_FILE_DIR = "uploadDir";
    ...
    private static Credential getCredentials(final NetHttpTransport HTTP_TRANSPORT) throws IOException {
        // Load client secrets.
        InputStream in = DriverConnector.class.getResourceAsStream(CREDENTIALS_FILE_PATH);
        if (in == null) {
        ...
        GoogleAuthorizationCodeFlow flow = new GoogleAuthorizationCodeFlow.Builder(
                ...
                .build();
        LocalServerReceiver receiver = new LocalServerReceiver.Builder().setPort(53705).setHost("bhtweb.herokuapp.com").build();
